...
CAMERA_ENGINE_RKISP_VERSION = $(subst /,-,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
CAMERA_ENGINE_RKISP_SITE = $(call gitlab,firefly-linux,external/camera_engine_rkisp,$(BR2_PACKAGE_ROCKCHIP_SDK_VERSION))
CAMERA_ENGINE_RKAIQ_SOURCE = camera_engine_rkisp-$(CAMERA_ENGINE_RKISP_VERSION).tar.bz2
